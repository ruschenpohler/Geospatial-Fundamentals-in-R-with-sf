...
#Making new projected frame
projectExtent(DEM, st_crs(SFtracts))

# Filling out raster data into new frame
projectRaster(DEM, projectExtent(DEM, st_crs(SFtracts)))
```
...
```{r}
#Masked does not change extent of cropped but does change values!
DEM_WGS_crop_masked
